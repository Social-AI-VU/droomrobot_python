...
class Kapinductie9(DroomrobotScript):
    ...
    def _introduction(self):
        ...
        self.add_move(self.droomrobot.say, 'en wat zo fijn is, is dat iedere keer als je het nodig hebt, je weer terug kan gaan in gedachten naar deze fijne plek')
        self.add_move(self.droomrobot.say, 'Je hoeft alleen maar diep in en uit te ademen. Ik ben benieuwd hoe goed dit je zometeen gaat helpen.')
