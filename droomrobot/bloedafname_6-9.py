...
class Bloedafname6:
    ...
    def run(self, child_name: str, child_age: int):
        ...
        sleep(0.5)
        self.droomrobot.say(f'Misschien is het weer {droomplek_lidwoord} {droomplek}, of een nieuwe droomwereld', speaking_rate=0.9)
        sleep(0.5)
        ...
        sleep(0.5)
        self.droomrobot.say('En stel je dan nu voor, dat je in jouw droomreis een superheld bent.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Met een speciale kracht.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Jij mag kiezen.', speaking_rate=0.9)
        sleep(0.5)
        ...
        if superkracht:
            ...
            sleep(0.5)
            self.droomrobot.say(f'Laten we samen oefenen hoe je jouw superkracht {superkracht} kunt activeren.', speaking_rate=0.9)
        else:
            sleep(0.5)
            self.droomrobot.say('Laten we samen oefenen hoe je die kracht kunt activeren.', speaking_rate=0.9)
        sleep(0.5)
        ...
        sleep(0.5)
        self.droomrobot.say('Merk maar eens hoe dat lichtje je een heel fijn, krachtig gevoel geeft.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('En hoe jij nu een superheld bent met jouw superkracht en alles aankan.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('En iedere keer als je het nodig hebt, kun je zoals je nu geleerd hebt, een paar keer diep in en uit ademen.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Hartstikke goed, ik ben benieuwd hoe goed het lichtje je zometeen gaat helpen.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Als je genoeg geoefend hebt, mag je je ogen weer lekker open doen en zeggen, het lichtje gaat mij helpen.', speaking_rate=0.9)
        sleep(1)
        ...
        sleep(0.5)
        self.droomrobot.say('Kijk maar weer naar alle mooie kleuren die om je heen zijn, en merk hoe fijn je je voelt op deze plek.', speaking_rate=0.9)
        sleep(0.5)
        ...
        self.droomrobot.say('Nu gaan we je superkracht weer activeren zoals je dat geleerd hebt.', speaking_rate=0.9)
        sleep(0.5)
        ...
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        self.droomrobot.say('En kijk maar hoe je krachtige lichtje weer op je arm verschijnt, in precies de goede kleur die je nodig hebt.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Zie het lichtje steeds sterker en krachtiger worden.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Zodat jij weer een superheld wordt en jij jezelf kan helpen.', speaking_rate=0.9)
        sleep(0.5)
        ...
        sleep(0.5)
        self.droomrobot.say('Als je iets voelt op je arm, dan is dat een teken dat je superkrachten volledig werken.', speaking_rate=0.9)
        sleep(0.5)
        self.droomrobot.say('Adem diep in.', speaking_rate=0.9)
        self.droomrobot.play_audio('resources/audio/breath_in.wav')
        self.droomrobot.say('en blaas uit.', speaking_rate=0.9)
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        self.droomrobot.say('Merk maar hoe goed jij jezelf kan helpen, je bent echt een superheld.', speaking_rate=0.9)
