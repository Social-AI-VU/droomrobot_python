...
class Bloedafname9:
    ...
    def run(self, participant_id, child_name: str, child_age: int):
        ...
        sleep(0.7)
        self.droomrobot.say(
            'En kijk maar hoe je krachtige lichtje weer op je arm verschijnt, in precies de goede kleur die je nodig hebt.', speaking_rate=0.75)
        sleep(0.7)
...
if __name__ == '__main__':
    bloedafname9 = Bloedafname9(mini_ip="10.0.0.148", mini_id="00010", mini_password="alphago",
                                redis_ip="10.0.0.142",
                                google_keyfile_path=abspath(join("..", "conf", "dialogflow", "google_keyfile.json")),
                                openai_key_path=abspath(join("..", "conf", "openai", ".openai_env")),
                                default_speaking_rate=0.8, computer_test_mode=False)
    bloedafname9.run('999', 'Sofie', 10)