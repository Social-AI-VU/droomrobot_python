...
class Bloedafname9:
    ...
    def run(self, child_name: str, child_age: int, robot_name: str = "Hero"):
        ...
        self.droomrobot.say(f'Misschien is dit weer {droomplek_lidwoord} {droomplek}, of een nieuwe fantasieplek')
        ...
        self.droomrobot.say('Luister naar de geluiden die je op die plek kan horen.')
        self.droomrobot.say('En hoe de temperatuur daar voelt, misschien is het heerlijk warm of lekker koel.')
        self.droomrobot.say('En stel je dan nu voor, dat er een luchtballon is op jouw fijne plek.')
        self.droomrobot.say('Die speciaal op jou staat te wachten.')
        self.droomrobot.say('Kijk maar eens welke kleur jouw luchtballon heeft.')
        self.droomrobot.say('Jij mag een ballonvaart gaan maken in die superveilige luchtballon.')
        self.droomrobot.say('Je mag je voorstellen dat je in de mand van de luchtballon stapt.')
        self.droomrobot.say('Als je goed in het mandje bent gestapt gaat de luchtballon in een prettig en rustig tempo omhoog.')
        self.droomrobot.say('Precies zo hoog als dat jij fijn vindt.')
        self.droomrobot.say('En kijk maar weer om je heen wat je allemaal ziet.')
        self.droomrobot.play_audio('resources/audio/birds.wav')
        self.droomrobot.say('Merk maar hoe fijn je je voelt op deze plek.')
        self.droomrobot.say('Dan gaan we nu oefenen hoe je je nog krachtiger en veiliger kan voelen.')
        self.droomrobot.say('Dit doe je door diep in en uit te ademen.')
        ...
        self.droomrobot.say('Dat lichtje laadt jouw kracht op.')
        ...
        ##
        self.droomrobot.say('Merk maar eens hoe dat {kleur_adjective} lichtje je een heel fijn, krachtig gevoel geeft.')
        ...
        self.droomrobot.say('Als dat gelukt is, mag je je ogen weer lekker open doen, en met je gedachten terugkomen in deze kamer.')
        ...
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        self.droomrobot.say(f'Stel je maar voor dat je weer bij {droomplek_lidwoord} {droomplek} bent.')
        self.droomrobot.say(
        ...
        self.droomrobot.say('Als je wil mag je weer een ritje maken in jouw speciale luchtballon, of je kan iets anders leuks doen op je fijne plek.')
        self.droomrobot.say('Merk maar hoe fijn jij je voelt op jouw fijne veilige plek.')
        self.droomrobot.say('Nu gaan we je kracht weer activeren zoals je dat geleerd hebt.')
        self.droomrobot.say('Adem in via je neus.')
        self.droomrobot.play_audio('resources/audio/breath_in.wav')
        self.droomrobot.say('en blaas rustig uit via je mond.')
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        self.droomrobot.say(
            'En kijk maar hoe je krachtige lichtje weer op je arm verschijnt in precies de goede kleur die je nodig hebt.')
        self.droomrobot.say('Zie het lichtje steeds sterker en krachtiger worden.')
        self.droomrobot.say('Zodat jij jezelf kan helpen.')
        ...
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        self.droomrobot.say('Merk maar hoe goed jij jezelf kan helpen, op je eigen veilige plek.')
