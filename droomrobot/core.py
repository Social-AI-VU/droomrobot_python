    ...
    def generate_practice_imagery(self, child_name, child_age, droomplek,
        ...
        fallback_payload = {
            "practice_imagery": [
                ...
                "Misschien is het er heerlijk warm. Voel de zonnestralen maar op je gezicht.",
    ...
    def generate_intervention_imagery(self, child_name, child_age, droomplek,
        ...
        fallback_payload = {
            ...
            "start_analogy": [
                ...
                "Jij bent de baas. Jij hebt alle controle.",
                ...
                f"Merk maar hoe lekker rustig je lichaam wordt en hoe veilig jij je voelt bij {droomplek_article} {droomplek}.",
                "En er is een lieve hond dicht bij je, helemaal rustig en zacht.",
