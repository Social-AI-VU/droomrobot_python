...
class Kapinductie6(DroomrobotScript):
    ...
    def _intervention_preparation(self, phase_moves: InteractionChoice) -> InteractionChoice:
        ...
        # intervention_prep_choice.add_move('strand', self.droomrobot.say, 'Het kan ook een lekker kriebelend gevoel in je buik geven.')
    ...
    def _intervention_procedure(self, phase_moves: InteractionChoice) -> InteractionChoice:
        ...
        # Ruimte
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Het voelt heerlijk zacht tegen je gezicht en het zal je beschermen.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Het houdt je helemaal veilig, zodat je nergens anders aan hoeft te denken dan aan je avontuur in de ruimte.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'En terwijl je in het ruimteschip zit, voel je hoe het ruimteschip met je meebeweegt, zacht en langzaam.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Je hebt alle controle over waar je naartoe wilt, je kunt naar de sterren vliegen of verder weg gaan, het maakt niet uit.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Voel de rust om je heen, terwijl je door de ruimte zweeft.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Nu zweef je rustig langs een prachtige planeet die helemaal van kleur is, misschien wel in een fel blauw, of paars, of misschien zie je wel ringen om de planeet heen.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Jij voelt je veilig en rustig, als een astronaut in je eigen avontuur.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Voel maar hoe je lichaam steeds lichter wordt nu je zo lekker in de ruimte zweeft.')
        intervention_procedure_choice.add_move('ruimte', self.droomrobot.say, 'Steeds lichter, steeds rustiger, helemaal ontspannen.')
