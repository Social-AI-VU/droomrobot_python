...
class Sonde6(DroomrobotScript):
    ...
    def _intervention_preparation(self, phase_moves: InteractionChoice) -> InteractionChoice:
        ...
        phase_moves.add_move(InterventionPhase.PREPARATION.name, self.droomrobot.mini.animate, SDKAnimationType.ACTION, "random_short4", run_async=True) ## Wave right hand
        phase_moves.add_move(InterventionPhase.PREPARATION.name, self.droomrobot.mini.animate, SDKAnimationType.EXPRESSION, "emo_007", run_async=True) ## Smile
        ...
        position_choice.add_move('zittend', self.droomrobot.say, 'Je mag weer goed gaan zitten en je ogen dicht doen zodat deze droomreis nog beter voor jou werkt.', sleep_time=1)
    ...
    def _build_interaction_choice_comfortable_position(self) -> InteractionChoice:
        ...
        position_choice.add_move('zittend', self.droomrobot.say, 'En terwijl je nu zo lekker zit, mag je je handen op je buik doen en rustig gaan ademhalen.')
        ...
        position_choice.add_move('liggend', self.droomrobot.say, 'En terwijl je nu zo lekker ligt, mag je je handen op je buik doen en rustig gaan ademhalen.')
        ...
        position_choice.add_move('other', self.droomrobot.say, 'En terwijl je hier zo fijn in de ruimte bent, mag je je handen op je buik doen en rustig gaan ademhalen.')
