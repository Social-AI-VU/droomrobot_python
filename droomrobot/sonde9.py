...
class Sonde9:
    ...
    def introductie(self, child_name: str, child_age: int):
        ...
        sleep(3)
        self.droomrobot.say(f'{str(child_age)} jaar. Oh wat goed, dan kan ik je een truukje leren om alles in het ziekenhuis makkelijker te maken.')
        ...
        self.droomrobot.say('Jij kunt namelijk heel makkelijk jezelf helpen in het ziekenhuis door je lichaam en hoofd te ontspannen.')
        ...
        self.droomrobot.say('En wat nu zo handig is aan dit truukje is dat het je ook kan helpen met het sonde inbrengen.')

        self.droomrobot.say('Door ergens anders aan te denken, zoals iets dat jij leuk vind, richt je je aandacht daarop in plaats van de sonde.')
        self.droomrobot.say('Dat maakt het vaker minder ongemakkelijk, en kan het fijner laten voelen.')
        self.droomrobot.say('Wat goed helpt is om je voor te stellen dat je in een raceauto door een tunnel scheurt, of van een waterglijvbaan gaat, of als dolfijn door het water beweegt.')
        ...
        # SAMEN OEFENEN
        self.droomrobot.say('Laten we alvast gaan oefenen om samen een ontspannen reis te maken, zodat het je zometeen gaat helpen bij het inbrengen van de sonde.')
        self.droomrobot.say('De sonde is een dun zacht buiksje dat heel makkelijk door je neus naar binnen kan om jou te helpen je beter te voelen.')
        ...
        self.droomrobot.say('dat maakt het makkelijker om je te concenteren.')
        self.droomrobot.say('En terwijl je nu zo zit, leg je rustig je handen op je buik doen en adem je kalm in en uit.')
    ...
    def interventie(self, child_name: str):
        ...
        self.droomrobot.say('Wat goed helpt is om je voor te stellen dat je in een raceauto door een tunnel scheurt, of van een waterglijvbaan gaat, of als dolfijn door het water beweegt.')
        self.droomrobot.say('Welke lijkt jij het leukste?')
        droomplek = self.droomrobot.ask_entity_llm('De waterglijbaan, de race-auto of dolfijn?')
        droomplek_lidwoord = self.droomrobot.get_article(droomplek)
        ...
        kleur_onderwerp = "raceauto"
        if droomplek:
            if 'raceauto' in droomplek:
                kleur_onderwerp = "raceauto"
            elif 'waterpretpark' in droomplek:
                kleur_onderwerp = "glijbaan"
            elif 'dolfijn' in droomplek:
                kleur_onderwerp = "dolfijn"
    
        kleur = self.droomrobot.ask_entity_llm(f'Welke kleur heeft jouw {kleur_onderwerp}?', strict=True)
    ...
    def dolfijn_oefenen(self, child_name: str, child_age: int):
        ...
        self.droomrobot.say('Je zult wellicht zien dat als je om je heen kijkt dat je dan de zonnenstralen door het water ziet schijnen.')
        sleep(1)
    ...
    def waterpretpark_interventie(self, child_name: str, kleur: str):
