...
class Bloedafname9:
    ...
    def introductie(self, child_name: str, child_age: int):
        ...
        sleep(0.7)
        self.droomrobot.say(f'Misschien is dit weer {droomplek_lidwoord} {droomplek}, of een nieuwe fantasieplek', speaking_rate=0.75)
        sleep(0.7)
        ...
        ##
        self.droomrobot.say(f'Merk maar eens, hoe dat {kleur_adjective} lichtje, je een heel fijn, krachtig gevoel geeft.', speaking_rate=0.75)
        sleep(0.7)
    ...
    def interventie(self, child_name: str):
        ...
        self.droomrobot.play_audio('resources/audio/breath_out.wav')
        sleep(0.7)
        self.droomrobot.say(f'Stel je maar voor dat je weer bij {droomplek_lidwoord} {droomplek} bent.', speaking_rate=0.75)
        sleep(0.7)
        self.droomrobot.say(
        ...
        sleep(0.7)
        self.droomrobot.say(
            f'En kijk maar hoe je krachtige {kleur} lichtje weer op je arm verschijnt, in precies de goede kleur die je nodig hebt.', speaking_rate=0.75)
        sleep(0.7)
        ...
        sleep(0.7)
        self.droomrobot.say(f'En als je het nodig hebt, stel je voor dat je {kleur} lichtje nog helderder gaat schijnen.', speaking_rate=0.75)
        sleep(0.7)
        ...
        if 'positive' in ging_goed:
            self.droomrobot.say(f'Wat fijn! je hebt jezelf echt goed geholpen, {child_name}')
        else:
