...
class ScriptTest(DroomrobotScript):
    ...
    def _test(self):
        ...
        self.add_move(droomrobot.say, 'Laten we even oefenen!')

        self.add_move(droomrobot.ask_entity,
        ...
        animal_choice.add_move('success', droomrobot.say, lambda: f'Een {self.user_model['dier']}')
        animal_choice.add_move('fail', droomrobot.say, 'Cool zeg.')
        self.add_choice(animal_choice)
        self.add_move(droomrobot.say, 'Klaar')
...
if __name__ == '__main__':
    ...
    droomrobot = Droomrobot(mini_ip="10.0.0.211", mini_id="00039", mini_password="mini",
                            redis_ip="10.0.0.205",
